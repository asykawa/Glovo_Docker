...
from FastApiCourse.course_app.admin import setup_admin
from FastApiCourse.course_app.api import cart, certificate, course_review, social_auth, lesson, course, network, \
    category, history, assigment, exam
from FastApiCourse.course_app.api import auth, favorite
from FastApiCourse.course_app.config import SECRET_KEY
