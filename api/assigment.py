...
from FastApiCourse.db.models import Assignment
from FastApiCourse.db.schema import AssignmentSchema
...
async def course_delete(assignment_id: int, db: Session = Depends(get_db)):
