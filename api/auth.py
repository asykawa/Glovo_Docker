...
from FastApiCourse.db.models import UserProfile, Refresh
from FastApiCourse.db.schema import UserProfileSchema, UserProfileLoginSchema
...
from FastApiCourse.config import (ALGORITHM, SECRET_KEY,
