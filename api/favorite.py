...
from FastApiCourse.db.models import Favorite, FavoriteItem, Course
from FastApiCourse.db.schema import FavoriteSchema, FavoriteItemSchema, FavoriteItemCreateSchema
